...
describe Normalizer do
	...
	describe '::normalize_restaurant_name' do
		["STARBUCKS", "STARBUCKS COFFEE", "Starbucks Coffee", "STARBUCKS COFFEE CO.", "Starbucks Coffee Company"].each do |starbucks_variant|
	    it 'normalizes Starbucks variants' do
	      expect(Normalizer.normalize_restaurant_name(starbucks_variant)).to eq('Starbucks Coffee')
	    end
	  end

	  ["PEET'S COFFEE & TEA", "PEET'S COFFEES & TEAS", "Peet's Coffee & Tea", "Peet's Coffee & Tea, Inc"].each do |peets_variant|
	...
	describe '::normalize_owner_name' do
		...
		["STARBUCKS COFFEE COMPANY", "STARBUCKS COFFEE CO.", "STARBUCKS CORP", "Starbucks Coffee Company", "Starbucks Coffee Co", "STARBUCKS COFFEE CORP", "Starbucks Corporation"].each do |starbucks_variant|
